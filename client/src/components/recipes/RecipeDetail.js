...
class RecipeDetail extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (
      !!document.getElementById("recipeHeader") &&
      document.getElementById("recipeHeader").offsetHeight !==
        this.state.headerHeight
    ) {
      this.setState({
        headerHeight: document.getElementById("recipeHeader").offsetHeight,
      });
    }
    if (
      !this.props.isSpinnerVisible &&
      prevProps.isSpinnerVisible &&
    ...
    return this.props.editMode && !isFetching ? (
      ...
      <Card style={detailStyle} onClick={this.props.onClose}>
        <AppBar className={this.props.classes.appBar} id="recipeHeader">
          ...
          {!!authorName && (
            <div
              style={{
                display: "flex",
                background: "linear-gradient(45deg, black, #303030)",
                padding: "10px",
              }}
            >
        ...
        <div
          style={{
            overflowY: "scroll",
            background: "linear-gradient(45deg, #101010, transparent)",
